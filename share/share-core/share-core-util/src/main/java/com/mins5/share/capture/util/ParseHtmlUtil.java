...
public class ParseHtmlUtil {
	...
	public static String parseAuthorAndSource(String html,String className){
		...
		String author= "";
		try {
			html = html.replace(className, "mytag");//带空格的class，如meta txt-shadow查找不到，先替换再查找
			Document doc = Jsoup.parse(html,"iso-8859-1");
	...
	public static void main(String []args){
		/*String s = "<span>时间：2014-04-03 22:20</span> <span>来源：<a href=\"http://www.managershare.com/2014/03/18/the-4-hour-workweek/\" target=\"_blank\">经理人分享</a></span> <span>作者：提摩西·费里斯</span>";
		String tString = s.replace("<span>", "").replace("</span>", "##");
		//System.out.println(tString);
		String [] strings  = tString.split("##");
		String time = strings[0].replace("时间：", "");
		String source =  strings[1].replace("来源：", "");
		String author =  strings[2].replace("作者：", "");
