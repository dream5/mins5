...
public class ImageUtils {
	...
	public static void main(String[] args) {
		...
		// 方法二：按高度和宽度缩放
		ImageUtils.scale2("d:/tmp/test.jpg", "d:/tmp/730x260.jpg", 260, 730, true);// 测试OK
		ImageUtils.scale2("d:/tmp/test.jpg", "d:/tmp/613x193.jpg", 193, 613, true);
		ImageUtils.scale2("d:/tmp/test.jpg", "d:/tmp/212x212.jpg", 212, 212, true);
		// 2-切割图像：
		// 方法一：按指定起点坐标和宽高切割
