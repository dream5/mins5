...
public interface ArticleService {
	 ...
	 * @return
	 */
	ReturnPageData<List<Article>> findAllCaptureArticlesByCondition(String articleTitle, Date beginTime, Date endTime, int currentPage,
			int onePageSize);
	 ...
	 * @return
	 */
	ReturnData<Article> findCaptureArticleById(Long id);
	 ...
	 * @since 2014年5月13日
	 */
	ReturnData<VOID> publishedArticleToTable(Long id, String articleKind, String articleLabel);
