...
public class ArticleLabelServiceImplTest {
	...
	public void testSaveArticleLabel() {
		...
		ReturnData<ArticleLabel> returnData = articleLabelService.saveArticleLabel(articleLabel);
		Assert.assertEquals(ReturnCode.SUCCESS.getCode(), returnData.getReturnCode());
	}
	
	@Test
	public void testDeleteArticleLabelById() {
		ReturnData<VOID> returnData = articleLabelService.deleteArticleLabelById(0L);
		Assert.assertEquals(ReturnCode.SUCCESS.getCode(), returnData.getReturnCode());
	}
	...
	public void testFindArticleLabelById() {
		ReturnData<ArticleLabel> returnData = articleLabelService.findArticleLabelById(1L);
		Assert.assertEquals(ReturnCode.SUCCESS.getCode(), returnData.getReturnCode());
	}
}
